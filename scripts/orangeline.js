    ...
    327: function(e, t, n) {
        ...
        a = function() {
            var e = {
                ...
                t = document.getElementById("navbar-secondary"),
                n = document.getElementById("sidenav-sticky");

            function r(e) {
                for (var t = 0; t < e.length; t++) e[t].parentElement.classList.remove("nav-active")
            }
            if (t && (e.any() || new Waypoint({
                    element: t,
                    handler: function(e) {
                        "down" == e ? this.element.classList.add("navbar-fixed--top") : this.element.classList.remove("navbar-fixed--top")
                    }
                })), n && function() {
                    for (var e = document.querySelectorAll("*[id]"), t = n.querySelectorAll("li a"), i = function(n) {
                            new Waypoint({
                                element: e[n],
                                handler: function(i) {
                                    console.log(e[n].id);
                                    for (var a = 0; a < t.length; a++) {
                                        var o = t[a].href.split("#")[1];
                                        e[n].id == o && (r(t), t[a].parentElement.classList.add("nav-active"))
                                    }
                                }
                            })
                        }, a = 0; a < e.length; a++) i(a)
                }(), document.querySelector("#navbar-product-top > .navbar-nav")) {
                var i = document.querySelector(".nav-mobile-menu"),
                    a = document.querySelector("#navbar-product-top > .navbar-nav"),
                    o = document.querySelectorAll("#navbar-product-top > .navbar-nav li"),
                    s = o[0].offsetHeight * o.length + 10,
                    l = !1;
                i.onclick = function() {
                    l ? (l = !1, a.style.height = "0px") : (l = !0, a.style.height = s + "px")
                }
            }
            if (document.querySelector(".navbar-subnav")) {
                var u = !1,
                    c = document.querySelector(".navbar-subnav .logo a"),
                    d = document.querySelector(".navbar-subnav .navbar-nav"),
                    p = document.querySelectorAll(".navbar-subnav .navbar-nav li"),
                    f = {};
                p[0] && (f = p[0].offsetHeight * (p.length + 1) + 10), e.any() && (d.innerHTML = "<li><a class='button' href='/'>" + c.innerHTML + " Home</a></li>" + d.innerHTML), c && (c.onclick = function(t) {
                    e.any() && (t.stopPropagation(), t.preventDefault(), u ? (u = !1, d.style.height = "0px") : (u = !0, d.style.height = f + "px"))
                })
            }
            ...
            i = function() {
                    ...
                    n = r.Prism = {
                            ...
                            clone: function(e, t) {
                                ...
                                switch (t = t || {}, r) {
                                    case "Object":
                                        ...
                                        a = {};
                                        for (var i in t[n.util.objId(e)] = a, e) e.hasOwnProperty(i) && (a[i] = n.util.clone(e[i], t));
                                        return a;
                                    case "Array":
                                        if (t[n.util.objId(e)]) return t[n.util.objId(e)];
                                        var a = [];
                        ...
                        languages: {
                            ...
                            insertBefore: function(e, t, r, i) {
                                var a = (i = i || n.languages)[e],
                                    o = {};
                                for (var s in a)
                                    if (a.hasOwnProperty(s)) {
                                        if (s == t)
                                            for (var l in r) r.hasOwnProperty(l) && (o[l] = r[l]);
                                        r.hasOwnProperty(s) || (o[s] = a[s])
                                    }
                                var u = i[e];
                                return i[e] = o, n.languages.DFS(n.languages, function(t, n) {
                                    n === u && t != e && (this[t] = o)
                                }), o
                            },
                            DFS: function(e, t, r, i) {
                                for (var a in i = i || {}, e) e.hasOwnProperty(a) && (t.call(e, a, e[a], r || a), "Object" !== n.util.type(e[a]) || i[n.util.objId(e[a])] ? "Array" !== n.util.type(e[a]) || i[n.util.objId(e[a])] || (i[n.util.objId(e[a])] = !0, n.languages.DFS(e[a], t, a, i)) : (i[n.util.objId(e[a])] = !0, n.languages.DFS(e[a], t, null, i)))
                            }
                        },
                        plugins: {},
                        ...
                        highlightAllUnder: function(e, t, r) {
                            ...
                            for (var a, o = i.elements || e.querySelectorAll(i.selector), s = 0; a = o[s++];) n.highlightElement(a, !0 === t, i.callback)
                        },
                        highlightElement: function(t, i, a) {
                            for (var o, s, l = t; l && !e.test(l.className);) l = l.parentNode;
                            l && (o = (l.className.match(e) || [, ""])[1].toLowerCase(), s = n.languages[o]), t.className = t.className.replace(e, "").replace(/\s+/g, " ") + " language-" + o, t.parentNode && (l = t.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + o));
                            var u = {
                                element: t,
                                language: o,
                                grammar: s,
                        ...
                        highlight: function(e, t, r) {
                            ...
                            return n.hooks.run("before-tokenize", a), a.tokens = n.tokenize(a.code, a.grammar), n.hooks.run("after-tokenize", a), i.stringify(n.util.encode(a.tokens), a.language)
                        },
                        matchGrammar: function(e, t, r, i, a, o, s) {
                            var l = n.Token;
                            for (var u in r)
                                if (r.hasOwnProperty(u) && r[u]) {
                                    ...
                                    for (var d = 0; d < c.length; ++d) {
                                        ...
                                        p = p.pattern || p;
                                        for (var v = i, w = a; v < t.length; w += t[v].length, ++v) {
                                            var k = t[v];
                                            if (t.length > e.length) return;
                                            if (!(k instanceof l)) {
                                                if (h && v != t.length - 1) {
                                                    if (p.lastIndex = w, !(C = p.exec(e))) break;
                                                    for (var x = C.index + (g ? C[1].length : 0), A = C.index + C[0].length, S = v, z = w, F = t.length; S < F && (z < A || !t[S].type && !t[S - 1].greedy); ++S) x >= (z += t[S].length) && (++v, w = z);
                                                    if (t[v] instanceof l) continue;
                                                    E = S - v, k = e.slice(w, z), C.index -= w
                                                } else {
                                                    p.lastIndex = 0;
                                                    var C = p.exec(k),
                                                        E = 1
                                                ...
                                                if (C) {
                                                    g && (m = C[1] ? C[1].length : 0);
                                                    A = (x = C.index + m) + (C = C[0].slice(m)).length;
                                                    var $ = k.slice(0, x),
                                                        _ = k.slice(A),
                                                        j = [v, E];
                                                    $ && (++v, w += $.length, j.push($));
                                                    var O = new l(u, f ? n.tokenize(C, f) : C, y, C, h);
                                                    if (j.push(O), _ && j.push(_), Array.prototype.splice.apply(t, j), 1 != E && n.matchGrammar(e, t, r, v, w, !0, u), o) break
                                                } else if (o) break
                                            }
                                        }
                                    }
                        ...
                        hooks: {
                            ...
                            run: function(e, t) {
                                var r = n.hooks.all[e];
                                if (r && r.length)
                                    for (var i, a = 0; i = r[a++];) i(t)
                            }
                        }
                    },
                    i = n.Token = function(e, t, n, r, i) {
                ...
                if (i.stringify = function(e, t, r) {
                    ...
                    var t = JSON.parse(e.data),
                        ...
                        a = t.code,
                        o = t.immediateClose;
                    r.postMessage(n.highlight(a, n.languages[i], i)), o && r.close()
                }, !1), r.Prism) : r.Prism;
                var a = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
                return a && (n.filename = a.src, n.manual || a.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(n.highlightAll) : window.setTimeout(n.highlightAll, 16) : document.addEventListener("DOMContentLoaded", n.highlightAll))), r.Prism
            }();
        e.exports && (e.exports = i), "undefined" != typeof global && (global.Prism = i), i.languages.markup = {
                comment: /<!--[\s\S]*?-->/,
                prolog: /<\?[\s\S]+?\?>/,
                                    ...
                                    for (var s = 0; s < o.length; s++) {
                                        ...
                                        if ("string" == typeof l || l.content && "string" == typeof l.content) {
                                            var u = r[n],
                                                ...
                                                p = d.indexOf("___" + t.toUpperCase() + u + "___");
                                            if (p > -1) {
                                                ++n;
                                                var f, g = d.substring(0, p),
                                                    h = new i.Token(t, i.tokenize(c, e.grammar, t), "language-" + t, c),
                                                    m = d.substring(p + ("___" + t.toUpperCase() + u + "___").length);
                                                if (g || m ? a(f = [g, h, m].filter(function(e) {
                                                        return !!e
                                                    })) : f = h, "string" == typeof l ? Array.prototype.splice.apply(o, [s, 1].concat(f)) : l.content = f, n >= r.length) break
                                            }
                                        } else l.content && "string" != typeof l.content && a(l.content)
                                    }
                            }(e.tokens)
                        }
                    }
            ...
            function(e) {
                ...
                boolean: /\b(?:true|false)\b/,
                null: /\bnull\b/
            }, i.languages.jsonp = i.languages.json, i.languages.scss = i.languages.extend("css", {
                comment: {
                    pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
                    lookbehind: !0
                },
            ...
            }), i.languages.scss.atrule.inside.rest = i.languages.scss, i.languages.python = {
                comment: {
                    pattern: /(^|[^\\])#.*/,
                    lookbehind: !0
                },
                ...
                operator: /[-+%=]=?|!=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
                punctuation: /[{}[\];(),.:]/
            }, i.languages.python["string-interpolation"].inside.interpolation.inside.rest = i.languages.python, i.languages.py = i.languages.python,
            function(e) {
            ...
            function() {
                if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
                    ...
                    }), i.hooks.add("complete", function e(t) {
                        var r = t.element.parentNode,
                            l = r && r.getAttribute("data-line");
                        if (r && l && /pre/i.test(r.nodeName)) {
                            clearTimeout(n);
                            var u = i.plugins.lineNumbers,
                                c = t.plugins && t.plugins.lineNumbers;
                            a(r, "line-numbers") && u && !c ? i.hooks.add("line-numbers", e) : (o(r, l), n = setTimeout(s, 1))
                        }
                ...
                function o(e, n, r) {
                    for (var o, s = (n = "string" == typeof n ? n : e.getAttribute("data-line")).replace(/\s+/g, "").split(","), l = +e.getAttribute("data-line-offset") || 0, u = (t() ? parseInt : parseFloat)(getComputedStyle(e).lineHeight), c = a(e, "line-numbers"), d = 0; o = s[d++];) {
                        var p = o.split("-"),
                            f = +p[0],
                            g = +p[1] || f,
                            h = e.querySelector('.line-highlight[data-range="' + o + '"]') || document.createElement("div");
                        if (h.setAttribute("aria-hidden", "true"), h.setAttribute("data-range", o), h.className = (r || "") + " line-highlight", c && i.plugins.lineNumbers) {
                            var m = i.plugins.lineNumbers.getLine(e, f),
                                y = i.plugins.lineNumbers.getLine(e, g);
                            m && (h.style.top = m.offsetTop + "px"), y && (h.style.height = y.offsetTop - m.offsetTop + y.offsetHeight + "px")
                        } else h.setAttribute("data-start", f), g > f && h.setAttribute("data-end", g), h.style.top = (f - l - 1) * u + "px", h.textContent = new Array(g - f + 2).join(" \n");
                ...
                function s() {
                    ...
                    if (t && !document.getElementById(e)) {
                        ...
                        i && (i.hasAttribute("data-line") || i.setAttribute("data-line", ""), o(i, t, "temporary "), document.querySelector(".temporary.line-highlight").scrollIntoView())
                    }
                }
            }()
    },
            ...
            if ("object" === ("undefined" == typeof window ? "undefined" : a(window)) && void 0 !== document.querySelectorAll && void 0 !== window.pageYOffset && void 0 !== history.pushState) {
                var e = function(e, t, n, r) {
                    ...
                    t = function(t, n, r, i) {
                        ...
                        ! function u() {
                            var c = Date.now() - s;
                            i !== window ? i.scrollTop = e(a, o, c, n) : window.scroll(0, e(a, o, c, n)), c > n ? "function" == typeof r && r(t) : l(u)
                        }()
                    },
                    n = function(e) {
    ...
    330: function(e, t, n) {
        ...
        ! function() {
            ...
            n.prototype.queueTrigger = function(e) {
                ...
                for (var i = 0, a = n.length; i < a; i++) n[i][e]()
        ...
        function() {
            ...
            function a(e) {
                this.element = e, this.Adapter = r.Adapter, this.adapter = new this.Adapter(e), this.key = "waypoint-context-" + t, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
                    ...
                    vertical: {},
                    horizontal: {}
                }, e.waypointContextKey = this.key, n[e.waypointContextKey] = this, t += 1, r.windowContext || (r.windowContext = !0, r.windowContext = new a(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
            }
                ...
                for (var n in t) {
                    ...
                    for (var a in this.waypoints[n]) {
                        ...
                        if (null !== o.triggerPoint) {
                            var s = r.oldScroll < o.triggerPoint,
                                l = r.newScroll >= o.triggerPoint;
                            (s && l || !s && !l) && (o.queueTrigger(i), e[o.group.id] = o.group)
                        }
                    }
                }
            ...
            i.prototype.add = function(e) {
                ...
                for (var n in this.triggerQueues) {
                    ...
                    for (var a = 0, o = r.length; a < o; a += 1) {
                        var s = r[a];
                        (s.options.continuous || a === r.length - 1) && s.trigger([n])
                    }
                }
        ...
        function() {
            ...
            i.prototype.innerHeight = function() {
                ...
                var r = e.split("."),
                    ...
                    a = r[1],
                    o = this.element;
                if (a && this.handlers[a] && i) n(o, this.handlers[a][i], t), this.handlers[a][i] = [];
                else if (i)
                    for (var s in this.handlers) n(o, this.handlers[s][i] || [], t), this.handlers[s][i] = [];
                ...
                function t(e, t) {
                    if ("object" === (void 0 === e ? "undefined" : r(e)) && "object" === (void 0 === t ? "undefined" : r(t)))
                ...
                var i = function(e, t) {
                    ...
                    var n, r = t.documentElement,
                        ...
                        y = function e(t, n, r) {
                            ...
                            r && e(t, n), d.forEach(function(e) {
                                t[i](e, n)
                            })
                        },
                        b = function(e, n, r, i, a) {
                            var o = t.createEvent("CustomEvent");
                            return o.initCustomEvent(n, !i, !a, r || {}), e.dispatchEvent(o), o
                        },
                        v = function(t, r) {
                            var i;
                            !a && (i = e.picturefill || n.pf) ? i({
                                reevaluate: !0,
                                elements: [t]
                            }) : r && r.src && (t.src = r.src)
                        },
                        ...
                        x = (T = [], B = [], N = T, q = function() {
                            var e = N;
                            for (N = T.length ? B : T, O = !0, P = !1; e.length;) e.shift()();
                            O = !1
                        }, L = function(e, n) {
                            O && !n ? e.apply(this, arguments) : (N.push(e), P || (P = !0, (t.hidden ? s : l)(q)))
                        }, L._lsFlush = q, L),
                        A = function(e, t) {
                            return t ? function() {
                                x(e)
                        ...
                        z = function() {
                            var a, l, d, p, k, z, C, E, $, _, j, O, P, T, B, N, q, L, W, M, H, I = /^img$/i,
                                D = /^iframe$/i,
                                ...
                                Z = -1,
                                U = function e(t) {
                                    Q--, t && t.target && y(t.target, e), (!t || Q < 0 || !t.target) && (Q = 0)
                                },
                                Y = function(e, n) {
                                    var i, a = e,
                                        o = "hidden" == w(t.body, "visibility") || "hidden" != w(e, "visibility");
                                    for ($ -= n, O += n, _ -= n, j += n; o && (a = a.offsetParent) && a != t.body && a != r;)(o = (w(a, "opacity") || 1) > 0) && "visible" != w(a, "overflow") && (i = a.getBoundingClientRect(), o = j > i.left && _ < i.right && O > i.top - 1 && $ < i.bottom + 1);
                                    return o
                                },
                                K = function() {
                                    var e, i, o, s, u, c, p, f, g;
                                    if ((k = n.loadMode) && Q < 8 && (e = a.length)) {
                                        i = 0, Z++, null == T && ("expand" in n || (n.expand = r.clientHeight > 500 && r.clientWidth > 500 ? 500 : 370), P = n.expand, T = P * n.expFactor), G < T && Q < 1 && Z > 2 && k > 2 && !t.hidden ? (G = T, Z = 0) : G = k > 1 && Z > 1 && Q < 6 ? P : 0;
                                        for (; i < e; i++)
                                            if (a[i] && !a[i]._lazyRace)
                                                if (R)
                                                    if ((f = a[i].getAttribute("data-expand")) && (c = 1 * f) || (c = G), g !== c && (C = innerWidth + c * B, E = innerHeight + c, p = -1 * c, g = c), o = a[i].getBoundingClientRect(), (O = o.bottom) >= p && ($ = o.top) <= E && (j = o.right) >= p * B && (_ = o.left) <= C && (O || j || _ || $) && (d && Q < 3 && !f && (k < 3 || Z < 4) || Y(a[i], c))) {
                                                        if (re(a[i]), u = !0, Q > 9) break
                                                    } else !u && d && !s && Q < 4 && Z < 4 && k > 2 && (l[0] || n.preloadAfterLoad) && (l[0] || !f && (O || j || _ || $ || "auto" != a[i].getAttribute(n.sizesAttr))) && (s = l[0] || a[i]);
                                        else re(a[i]);
                                        s && !u && re(s)
                                    }
                                },
                                X = (N = K, L = 0, W = 666, M = function() {
                                    q = !1, L = i.now(), N()
                                }, H = u ? function() {
                                    u(M, {
                                        timeout: W
                                    ...
                                    var t;
                                    (e = !0 === e) && (W = 44), q || (q = !0, (t = 125 - (i.now() - L)) < 0 && (t = 0), e || t < 9 && u ? H() : s(H, t))
                                }),
                                J = function(e) {
                                    h(e.target, n.loadedClass), m(e.target, n.loadingClass), y(e.target, ee)
                                },
                                V = A(J),
                                ee = function(e) {
                                    V({
                                ...
                                te = function(e) {
                                    ...
                                    (t = n.customMedia[e.getAttribute("data-media") || e.getAttribute("media")]) && e.setAttribute("media", t), i && e.setAttribute("srcset", i), t && ((r = e.parentNode).insertBefore(e.cloneNode(), e), r.removeChild(e))
                                },
                                ne = A(function(e, t, r, i, a) {
                                    var o, l, u, d, g, w;
                                    (g = b(e, "lazybeforeunveil", t)).defaultPrevented || (i && (r ? h(e, n.autosizesClass) : e.setAttribute("sizes", i)), l = e.getAttribute(n.srcsetAttr), o = e.getAttribute(n.srcAttr), a && (u = e.parentNode, d = u && c.test(u.nodeName || "")), w = t.firesLoad || "src" in e && (l || o || d), g = {
                                        target: e
                                    }, w && (y(e, U, !0), clearTimeout(p), p = s(U, 2500), h(e, n.loadingClass), y(e, ee, !0)), d && f.call(u.getElementsByTagName("source"), te), l ? e.setAttribute("srcset", l) : o && !d && (D.test(e.nodeName) ? function(e, t) {
                                        try {
                                        ...
                                        src: o
                                    })), e._lazyRace && delete e._lazyRace, m(e, n.lazyClass), x(function() {
                                        (!w || e.complete && e.naturalWidth > 1) && (w ? U(g) : Q--, J(g))
                                    }, !0)
                                }),
                                re = function(e) {
                                    var t, r = I.test(e.nodeName),
                                        i = r && (e.getAttribute(n.sizesAttr) || e.getAttribute("sizes")),
                                        a = "auto" == i;
                                    (!a && d || !r || !e.src && !e.srcset || e.complete || g(e, n.errorClass)) && (t = b(e, "lazyunveilread").detail, a && F.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, Q++, ne(e, t, a, i, r))
                                },
                                ie = function e() {
                                    if (!d)
                                        if (i.now() - z < 999) s(e, 999);
                                        else {
                                            var t = S(function() {
                                                n.loadMode = 3, X()
                                            });
                                            d = !0, n.loadMode = 3, X(), o("scroll", function() {
                            ...
                            return {
                                _: function() {
                                    z = i.now(), a = t.getElementsByClassName(n.lazyClass), l = t.getElementsByClassName(n.lazyClass + " " + n.preloadClass), B = n.hFac, o("scroll", X, !0), o("resize", X, !0), e.MutationObserver ? new MutationObserver(X).observe(r, {
                                        childList: !0,
                                        subtree: !0,
                                        attributes: !0
                                    }) : (r.addEventListener("DOMNodeInserted", X, !0), r.addEventListener("DOMAttrModified", X, !0), setInterval(X, 999)), o("hashchange", X, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend", "webkitAnimationEnd"].forEach(function(e) {
                                        t.addEventListener(e, X, !0)
                                    }), /d$|^c/.test(t.readyState) ? ie() : (o("load", ie), t.addEventListener("DOMContentLoaded", X), s(ie, 2e4)), a.length ? (K(), x._lsFlush()) : X()
                                },
                                checkElems: X,
                                unveil: re
                            }
                        ...
                        F = ($ = A(function(e, t, n, r) {
                            var i, a, o;
                            if (e._lazysizesWidth = r, r += "px", e.setAttribute("sizes", r), c.test(t.nodeName || ""))
                                for (i = t.getElementsByTagName("source"), a = 0, o = i.length; a < o; a++) i[a].setAttribute("sizes", r);
                            n.detail.dataAttr || v(e, n.detail)
                        }), _ = function(e, t, n) {
                            var r, i = e.parentNode;
                            i && (n = k(e, i, n), (r = b(e, "lazybeforesizes", {
                                width: n,
                                dataAttr: !!t
                            })).defaultPrevented || (n = r.detail.width) && n !== e._lazysizesWidth && $(e, i, r, n))
                        }, j = S(function() {
                            var e, t = E.length;
                            if (t)
                                for (e = 0; e < t; e++) _(E[e])
                            ...
                            _: function() {
                                E = t.getElementsByClassName(n.autosizesClass), o("resize", j)
                            },
                            checkElems: j,
                            updateElem: _
                        }),
